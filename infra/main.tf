...
# KV-Secrets mit SQL-Daten - AUSKOMMENTIERT für später
...
# Container App mit UAMI - AUSKOMMENTIERT für später
...
# Rollen für die UAMI (Runtime) - AUSKOMMENTIERT für später
...
# Role Assignment für Terraform - AUSKOMMENTIERT für später (Key Vault bezogen)
...
# Random password für SQL Server Admin - AUSKOMMENTIERT für später
...
# Azure SQL Server - AUSKOMMENTIERT für später
...
# Firewall Regel für Azure Services - AUSKOMMENTIERT für später
